...
namespace FoundersPlugin.Modules
{
    public class AdsModule : MonoBehaviour, IModule
    {
        ...
        #region JavaScript External Methods

        [DllImport("__Internal")]
        private static extern void ShowFullscreenAd_js(string messageController);

        [DllImport("__Internal")]
        private static extern void ShowRewardedVideo_js(string messageController, int id);
        ...
        public void SetAdCooldown(float cooldown)
        {
            adCooldown = cooldown;
        }

        public float GetAdCooldown()
        {
            return adCooldown;
        }
    ...
    public static class Ads
    {
        ...
        /// <summary>
        /// Устанавливает время задержки между показами рекламы
        /// </summary>
        public static void SetAdCooldown(float cooldown)
        {
            if (IsModuleAvailable())
            {
                AdsModule.Instance.SetAdCooldown(cooldown);
            }
        }

        /// <summary>
        /// Возвращает текущее время задержки между показами рекламы
        /// </summary>
        public static float GetAdCooldown()
        {
            return IsModuleAvailable() ? AdsModule.Instance.GetAdCooldown() : 0f;
        }
        ...
        /// <summary>
        /// Запускает игровой процесс (делегирует вызов в YandexGameManager)
        /// </summary>
        ...
        /// <summary>
        /// Останавливает игровой процесс (делегирует вызов в YandexGameManager)
        /// </summary>
