...
namespace FoundersKit.Modules
{
    ...
    {
        public const string CONTEXT_NAME = "TimerAds";
        ...
        {
            if (!DataModule.savesData.isAdAllowed)
            {
        ...
        private void Awake()
        {
            ...
            {
                Log.Warning($"Change the Ads Display Interval value. Must be >= 60. Current: {advertisingInterval}", CONTEXT_NAME);
        ...
        private void Update()
        {
            ...
            if (!_countdownActive
                ...
                && adsModule.CanShowAd()
                && !isAdDisplayError
                && DataModule.savesData.isAdAllowed

                //&& !DataModule.serviceData.isScreenOpen
