...
namespace FoundersPlugin.Modules
{
    ...
    public class AdsModule : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            YandexGameManager.UnityLog("Initialized", "success", moduleAttribute);
        }
        #endregion
        ...
        public void OnFullAdOpen()
        {
            ...
            YandexGameManager.Log("Full ad opened", "info", moduleAttribute);
        ...
        public void OnFullAdClose(string wasShown)
        {
            ...
            if (shown)
            {
                YandexGameManager.Log($"Full ad closed. Shown={shown}", "success", moduleAttribute);
            }
            else
            {
                YandexGameManager.Log($"Full ad closed. Shown={shown}", "warning", moduleAttribute);
            }
        ...
        {
            YandexGameManager.Log("Full ad error", "error", moduleAttribute);
        ...
        public void OnRewardedOpen()
        {
            ...
            YandexGameManager.Log("Rewarded ad opened", "info", moduleAttribute);
        ...
        {
            YandexGameManager.Log("Rewarded ad closed", "success", moduleAttribute);
        ...
        {
            YandexGameManager.Log("Rewarded ad error", "error", moduleAttribute);
        ...
        {
            YandexGameManager.Log($"Video ad rewarded, ID: {id}", "success", moduleAttribute);
