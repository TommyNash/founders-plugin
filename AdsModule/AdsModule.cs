...
namespace FoundersKit.Modules
{
    ...
    public class AdsModule : MonoBehaviour
    {
        ...
        private string moduleAttribute = "AdsModule";
        #endregion
        ...
        private void Initialize()
        {
            ...
            {
                isInitialized = true;
                YandexGameManager.Log("Module initialized", "success", moduleAttribute);
            }
            catch (Exception ex)
            {
                YandexGameManager.Log($"Error initializing AudioModule: {ex.Message}", "error", moduleAttribute);
            }
        }
        #endregion
        ...
        public void ShowFullscreen()
        {
            if (CanShowAd())
            {
                YandexGameManager.UnityLog($"ShowFullscreen at {Time.time:F1}", "info", moduleAttribute);
                ResetAdTimer();
#if UNITY_EDITOR
            ...
            else
            {
                ...
                YandexGameManager.UnityLog($"Cannot show fullscreen ad. Cooldown: {timeLeft:F1}s remaining", "warning", moduleAttribute);
            }
        }
        ...
        public void ShowRewarded(int rewardId)
        {
            ...
            YandexGameManager.UnityLog($"ShowRewarded(ID={rewardId}) at {Time.time:F1}", "info", moduleAttribute);
#if UNITY_EDITOR
        ...
        public void OnFullAdOpen()
        {
            ...
            YandexGameManager.UnityLog("Full ad opened", "info", moduleAttribute);
        ...
        public void OnFullAdClose(string wasShown)
        {
            ...
            if (shown)
            {
                YandexGameManager.UnityLog($"Full ad closed. Shown={shown}", "success", moduleAttribute);
            }
            else
            {
                YandexGameManager.UnityLog($"Full ad closed. Shown={shown}", "warning", moduleAttribute);
            }
        ...
        {
            YandexGameManager.UnityLog("Full ad error", "error", moduleAttribute);
        ...
        public void OnRewardedOpen()
        {
            ...
            YandexGameManager.UnityLog("Rewarded ad opened", "info", moduleAttribute);
        ...
        {
            YandexGameManager.UnityLog("Rewarded ad closed", "success", moduleAttribute);
        ...
        {
            YandexGameManager.UnityLog("Rewarded ad error", "error", moduleAttribute);
        ...
        {
            YandexGameManager.UnityLog($"Video ad rewarded, ID: {id}", "success", moduleAttribute);
