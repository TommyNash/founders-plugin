...
namespace FoundersKit.Modules
{
    ...
    public class AudioDatabase : ScriptableObject
    {
        ...
        // Регулярные выражения для валидации (скомпилированные для производительности)
        private static readonly Regex keyValidationRegex = new Regex(@"^[a-zA-Z0-9_]+$", RegexOptions.Compiled);
        private static readonly Regex pathValidationRegex = new Regex(@"^[a-zA-Z0-9_/.-]+$", RegexOptions.Compiled);
