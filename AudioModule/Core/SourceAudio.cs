...
namespace FoundersPlugin.Modules
{
    ...
    public enum AudioProviderType
    {
        ...
        JS,     // JavaScript (Howler.js) провайдер
    ...
    /// </summary>
    [AddComponentMenu("FoundersPlugin/Audio/Source Audio")]
    public class SourceAudio : MonoBehaviour
    {
        ...
        private void Initialize()
        {
            ...
            try
            {
                ...
                // Регистрируем источник в AudioManagement
                AudioManagement.Instance.RegisterSource(this);
        ...
        private void PlayJS(string key)
        {
            #if UNITY_WEBGL && !UNITY_EDITOR
        ...
        private void SetVolume(float value)
        {
            ...
            float actualVolume = value * AudioManagement.Instance.GetVolume();
            ...
            {
                #if UNITY_WEBGL && !UNITY_EDITOR
                WebGLAudioBridge.SetVolume(currentKey, actualVolume);
                #endif
            }
        }
        ...
        private void SetPitch(float value)
        {
            ...
            {
                #if UNITY_WEBGL && !UNITY_EDITOR
                WebGLAudioBridge.SetPitch(currentKey, value);
                #endif
            }
        }
        ...
        {
            #if UNITY_WEBGL && !UNITY_EDITOR
            WebGLAudioBridge.StopSound(currentKey);
            #endif
        }

        private void PauseJS()
        {
            #if UNITY_WEBGL && !UNITY_EDITOR
            WebGLAudioBridge.PauseSound(currentKey);
            #endif
        }
        ...
        private void OnDestroy()
        {
            ...
            {
                AudioManagement.Instance.UnregisterSource(this);
            }
        }
        ...
        private IEnumerator FadeCoroutine(float startVolume, float endVolume, float duration)
        {
            ...
            while (elapsed < duration)
            {
                ...
                else if (providerType == AudioProviderType.WebGL)
                {
                    WebGLAudioBridge.SetVolume(currentKey, currentVolume);
                }
